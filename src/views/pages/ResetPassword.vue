<!-- <template>
    <div class="bg-slate-100 mx-40 my-40 rounded text-left p-10">
      ...
      <form @submit.prevent="resetPassword" class="my-5">
        ...
        <div class="relative flex items-center sm:col-span-2 my-4">
          ...
          <input type="password" id="password" v-model="resetData.password" autocomplete="new-password" placeholder="Enter password"
        ...
        <div class="relative flex items-center sm:col-span-2 my-4">
          ...
          <input type="password" id="password_confirmation" v-model="resetData.password_confirmation" required autocomplete="new-password" placeholder="Enter password"
            class="px-4 py-3.5 bg-white text-black w-full text-sm border-2 border-gray-100 focus:border-blue-500 rounded outline-none" />
          <svg xmlns="http://www.w3.org/2000/svg" fill="#bbb" stroke="#bbb"
            class="w-[18px] h-[18px] absolute right-4 cursor-pointer" viewBox="0 0 128 128">
            <path
        ...
        <button type="submit" class="bg-blue-600 text-lg font-bold px-4 py-2 rounded hover:bg-blue-800 text-white">Reset Password</button>
      </form>
