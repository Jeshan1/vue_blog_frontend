    ...
    <div class="my-10 mx-24">
         <Carousel :value="blogData.blogs" :numVisible="3" :numScroll="1" :responsiveOptions="responsiveOptions" circular :autoplayInterval="3000" class="my-4">
             <template #item="slotProps">
                 <div class="bg-white shadow-[0_4px_12px_-5px_rgba(0,0,0,0.4)] w-full h-[500px] max-w-sm rounded-lg overflow-hidden mx-auto font-[sans-serif]">
                     ...
                     <div class="p-6 text-left">
                         ...
                         <p class="mt-4 text-sm text-gray-500 leading-relaxed">{{ slotProps.data.description.split(" ").slice(0,8).join(" ")+"..." }}</p>
