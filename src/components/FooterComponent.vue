        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div class="lg:flex lg:items-center">
            <ul class="flex space-x-6">
              <li>
                <a href="https://www.facebook.com/jection.jection.564/">
              ...
              <li>
                <a href="https://www.linkedin.com/in/jeshan-tiwari-012ab527b/">
                  <svg xmlns="http://www.w3.org/2000/svg" class="fill-gray-300 hover:fill-white w-7 h-7" viewBox="0 0 24 24">
                    <path fill-rule="evenodd"
          ...
          <div>
            ...
            <ul class="space-y-4 pl-2">
              <li>
                <router-link to="/features" class="text-gray-300 hover:text-white text-sm">Featured</router-link>
              </li>
              <li>
                <router-link to="/blogs" class="text-gray-300 hover:text-white text-sm">Blogs</router-link>
              </li>
              <li>
                <router-link to="/home" class="text-gray-300 hover:text-white text-sm">New Arrivals</router-link>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul class="space-y-4 pl-2">
              <li>
                <router-link to="/about" class="text-gray-300 hover:text-white text-sm">About Us</router-link>
              </li>
              <li>
              ...
              <li>
                <router-link to="/contact" class="text-gray-300 hover:text-white text-sm">Contact Us</router-link>
              </li>
              <li>
                <a href="https://github.com/Jeshan1/vue_blog_frontend" class="text-gray-300 hover:text-white text-sm">Documentation</a>
              </li>
            </ul>
          </div>
        </div>
